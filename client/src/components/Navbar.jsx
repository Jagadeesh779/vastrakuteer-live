                    ...
                    <div className="flex justify-between h-20 items-center gap-8 relative">
                        ...
                        <div className="hidden md:flex items-center flex-1">
                            ...
                            <Link to="/home" className="flex items-center h-full py-0" style={{ textDecoration: 'none' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', lineHeight: 1, marginLeft: '12px' }}>
                                    <span style={{ fontFamily: "'Great Vibes', cursive", fontSize: '2.5rem', fontWeight: 400, color: '#1a5c3a', lineHeight: 1, marginLeft: '10px' }}>Vastra</span>
                                    <span style={{ fontFamily: 'Georgia, serif', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '0.35em', color: '#1a1a1a', textTransform: 'uppercase', marginTop: '-3px', marginLeft: '12px' }}>KUTEER</span>
                                </div>
                            </Link>

                            {/* Desktop Navigation */}
                            <div className="flex space-x-6 lg:space-x-8 items-center pt-1 ml-auto mr-32">
                                ...
                                <Link to="/shop" className="text-gray-900 hover:text-emerald-700 font-bold transition-colors relative group text-[16px] whitespace-nowrap">
                                    Shop
                                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-emerald-600 transition-all group-hover:w-full"></span>
                                </Link>
                                <Link to="/collections" className="text-gray-900 hover:text-emerald-700 font-bold transition-colors relative group text-[16px] whitespace-nowrap">
                                    Collections
                                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-emerald-600 transition-all group-hover:w-full"></span>
                                </Link>
                                <Link to="/about" className="text-gray-900 hover:text-emerald-700 font-bold transition-colors relative group text-[16px] whitespace-nowrap">
                                    About Us
                                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-emerald-600 transition-all group-hover:w-full"></span>
                                </Link>
                                {/* Admin Link Check */}
                                {user && user.role === 'admin' && (
                                    <Link to="/admin" className="text-red-600 font-bold hover:text-red-800 transition-colors text-[16px] whitespace-nowrap">Admin Dashboard</Link>
                                )}
                            </div>
                        </div>
