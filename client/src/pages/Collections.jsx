...
const SkeletonCategory = () => (
    <div className="rounded-2xl aspect-[4/5] max-w-sm w-full mx-auto overflow-hidden animate-pulse" style={{ background: 'rgba(245,243,255,0.8)' }}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {paginated.length > 0 ? paginated.map((cat) => (
                                    <div
                                        ...
                                        className="relative group overflow-hidden rounded-2xl aspect-[4/5] max-w-sm w-full mx-auto cursor-pointer shadow-lg hover:shadow-xl transition-shadow"
                                    >
