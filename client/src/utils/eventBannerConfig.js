...
const EVENTS = [
    ...
    {
        id: 'ugadi',
        name: 'Ugadi / Tamil New Year',
        emoji: '🌸',
        start: { month: 3, day: 29 },
        end:   { month: 4, day: 2 },
        colors: { bg: 'linear-gradient(135deg,#14532d 0%,#166534 60%,#15803d 100%)', accent: '#fde68a', text: '#f0fdf4' },
        announcements: [
            { text: '🌸 Ugadi Special — Flat 20% OFF on Traditional Sarees!', linkText: 'Shop Now', link: '/shop' },
            { text: '🎊 Telugu New Year — Fresh Fashion, Fresh Beginnings!', linkText: 'Explore', link: '/collections' },
        ],
        saleHeadline: 'Ugadi Sale — Flat 20% OFF',
        subText: 'Welcome the Telugu New Year with our exclusive traditional saree collection.',
        coupon: 'UGADI20',
        stats: [{ value: '20%', label: 'Flat Discount' }, { value: '175+', label: 'Sarees' }, { value: '₹849', label: 'Starts From' }],
        popupTitle: 'Ugadi Subhakankshalu! 🌸',
        popupOffer: 'Flat 20% off on all orders',
        popupCoupon: 'UGADI20',
    },
    {
